        ...
        <HomePage title={pageTitle}>
            ...
            <div className="container">
                <div className="d-flex justify-content-center">
                    <div className="card pt-5" style={{ borderRadius: "30px", padding: "20px", width: "80%", maxWidth: "1200px", height: "auto", borderColor: "#D8BABD" }}>
                        {/* ปุ่มรีเฟรช */}
                        {/* การค้นหาและกรอง */}
                                    ...
                                    {statusOptions.map((option) => (
                                        <button
                                            ...
                                            style={{
                                                ...
                                                color: filterStatus === option.value ? "#5B166C" : "#000", // เปลี่ยนสีข้อความเมื่อเลือก
                                        ...
                                        >
                                            ...
                                            <span
                                                style={{
                                                    ...
                                                    bottom: "-5px",
                                                    left: "50%",
                                                    transform: filterStatus === option.value ? "translateX(-50%)" : "translateX(-50%) scaleX(0)",
                                                    width: "80%", // ความยาวเส้น
                                                    height: "6px", // ความหนา
                                                    backgroundColor: filterStatus === option.value ? "#5B166C" : "transparent", // สีเส้น
                        ...
                        {loading ? (
                            ...
                            <div>
                                {currentOrders.map((order, index) => (
                                    <div key={order.id}>
                                        <div 
                                            className="d-flex justify-content-between align-items-center my-3 px-5"
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex">
                                                    ...
                                                    >
                                                        ...
                                                        order.status === 'shiped' ? 'จัดส่งแล้ว' :
