        ...
        <div className="container">
          <div>
            <div className="d-flex justify-content-center" style={{ marginTop: "50px" }}>
              <div className="p-3" style={{ flex: 1, overflowWrap: "break-word" }}>
                <h5 className="text-black" style={{ textAlign: "right", marginRight: "20px" }}>รายละเอียดสินค้า</h5>
          ...
          <div>
            <div className="d-flex justify-content-center" style={{ marginTop: "100px" }}>
              ...
              <div className="p-3" style={{ flex: 1, overflowWrap: "break-word" }}>
                <h5 className="text-black" style={{ textAlign: "left", marginRight: "20px" }}>รายละเอียดสินค้า</h5>
